        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                <div class="block">  
					...
					<tr class="odd gradeX">
		<?php
           $query = "SELECT tbl_post.*, tbl_catagory.name FROM tbl_post INNER JOIN tbl_catagory
...
<td><?php echo $fm->formatDate($result['date']); ?></td>
 ...
 <a onclick ="return confirm('Are you sure to Delete Post?')"; href="deletepost.php?deletepostId=<?php echo $result['id']; ?>">Delete</a>
